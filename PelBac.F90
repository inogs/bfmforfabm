...
!     call self%initialize_ogs_bfm_base(sedimentation=.true.)
      ...
      call self%register_diagnostic_variable(self%id_eN4n, 'eN4n', '-','External nutrient limitation')
      call self%register_diagnostic_variable(self%id_eN1p, 'eN1p', '-','External nutrient limitation')
      ...
      call self%register_diagnostic_variable(self%id_cuR1, 'cuR1', '-','correction of organic material quality')
      call self%register_diagnostic_variable(self%id_cuR6,'cuR6', '-','correction of organic material quality')
      call self%register_diagnostic_variable(self%id_iNIn, 'iNIn', '-','Nutrient limitation')
      call self%register_diagnostic_variable(self%id_iN1p, 'iN1p', '-','Nutrient limitation')
      call self%register_diagnostic_variable(self%id_iN, 'iN', '-','Total Nutrient limitation')
      ...
      call self%register_diagnostic_variable(self%id_ruR6p,'ruR6p', 'mmolP/m3/d',' Organic Phosphorus uptake')
      call self%register_diagnostic_variable(self%id_rrc,'rrc', 'mgC/m3/d','Aerobic and anaerobic respiration')
      call self%register_diagnostic_variable(self%id_flN6rPBA,'flN6rPBA', '-','electron acceptor in the respiration process')
      select case (self%p_version)
         case ( BACT1 )
          call self%register_diagnostic_variable(self%id_renh4,'ren', 'mmolN/m3/d','Direct uptake of ammonium')
          call self%register_diagnostic_variable(self%id_rep,'rep', 'mmolP/m3/d','Direct uptake of phosphate')
         case ( BACT2 )
          call self%register_diagnostic_variable(self%id_run,'run', 'mgC/m3/d','Net production')
          call self%register_diagnostic_variable(self%id_renh4,'renh4', 'mmolN/m3/d','Ammonium remineralization')
          call self%register_diagnostic_variable(self%id_rumn3,'rumn3', 'mmolN/m3/d','Nitrate uptake')
          call self%register_diagnostic_variable(self%id_rumn4,'rumn4', 'mmolN/m3/d','Ammonium uptake')
          call self%register_diagnostic_variable(self%id_rumn,'rumn', 'mmolN/m3/d','Nitrogen uptake')
          call self%register_diagnostic_variable(self%id_ren,'ren', 'mmolN/m3/d','actual Inorganic Nitrogen uptake')
          call self%register_diagnostic_variable(self%id_repo4,'rep', 'mmolP/m3/d','Phosphate remineralization')
         ...
         case ( BACT3 ) 
          ...
          call self%register_diagnostic_variable(self%id_ren,'ren', 'mmolN/m3/d','Dissolved Nitrogen dynamics')
          call self%register_diagnostic_variable(self%id_rep,'rep', 'mmolP/m3/d','Dissolved Phosphorus dynamics')
  end select
   end subroutine
