module ogs_bfm_shared
   ...
   real(rk),parameter :: p_qo2cr       = 1.0_rk          ! Oxygen consumed per unit of carbon respired [mol_O2/mol_C]
   real(rk),parameter :: p_qo2cf       = 1.0_rk          ! Oxygen consumed per unit of carbon fixed [mol_O2/mol_C]
